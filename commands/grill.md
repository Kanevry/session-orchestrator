...
3. **Phase 2 — Grill Loop** — one question per turn via `AskUserQuestion`, applying the Five Tactics (glossary conflict, sharpen fuzzy language, code contradiction, edge-case scenario, assumption audit); read the repo before asking.
