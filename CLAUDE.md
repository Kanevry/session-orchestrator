...
- **Tests:** 5285 passed / 0 failed / 12 skipped (+30 net from 2026-05-16 deep-2; CI pipeline TBD after push). validate-plugin 43/43, typecheck 68/68, lint 0.
- **Backlog:** ~5-7 open post 2026-05-16 deep-3 cut (closed Anthropic-adoption cluster GL #409 #410 #411 #412 #414 + GH #45). Open: GitHub #34 (awesome-list submission), GitHub #43 (Codex plugin icon), GitHub #44 (MED path-traversal --vault-dir SEC follow-up). Open-on-GitLab: #386 (mac-gate end2end), #403 (RUBRIC_GLASS_V2 profile-config flag), #413 (LOW spike: AI security CI component, draft). Tracking-only: #305 · #213 · #123 · #341. Data-gated: #297 / #298. Low-pri chore: #372 schema_version v2 bump.
