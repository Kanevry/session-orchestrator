...
See [`README.md`](./README.md#components) for the canonical inventory (34 skills, 14 commands, 11 agents, 10 hook event matchers / 10 hook handlers). Runtime layout: `skills/`, `commands/`, `agents/`, `hooks/`, `.orchestrator/policy/`, `.claude/rules/`. Stable product/tech/structure context lives at `.orchestrator/steering/{product,tech,structure}.md` and is injected at session-start Phase 2.6 (when present).
...
- **Tests:** 5129 passed / 0 failed / 12 skipped (+128 net from 2026-05-16 housekeeping-1; CI pipeline TBD after push). validate-plugin 43/43, typecheck 67/67, lint 0.
- **Backlog:** ~9-11 open post 2026-05-16 deep-1 cut (closed #41 #42 this session). Open: GitHub #35-#40 (superpowers-adoption cluster), GitHub #34 (awesome-list submission), GitHub #43 (Codex plugin icon), GitHub #44 (MED path-traversal --vault-dir SEC follow-up for gitlab-portfolio), GitHub #45 (LOW execFile AbortSignal resource hygiene). Plus open-on-GitLab: #386 (mac-gate end2end), #403 (RUBRIC_GLASS_V2 profile-config flag). Tracking-only: #305 · #213 · #123 · #341. Data-gated: #297 / #298. Low-pri chore: #372 schema_version v2 bump.
