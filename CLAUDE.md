...
- **Backlog:** ~43 open issues (verified 2026-04-28 mid-session; up from ~30 baseline as new bugs/chores filed during deep-session work). Remaining cluster: epics (#309, #229, #271, #181, #161, #124), baseline-MR-blocked (#314, #315), autopilot-RUNS-blocked (#297, #298), v3 release tracking (#152, #153, #154, #213), plus a thin tail of priority:low chores.
