...
- **Tests:** 5843 passed / 0 failed / 12 skipped (+31 net from 2026-05-18 deep-2 #462 privacy scrub + #469 cross-repo config + #461 wave-reviewers rename + #471 owner-leakage guard). validate-plugin gains new owner-leakage Check, typecheck 188 files OK (+1 wave-reviewers.mjs), lint 0.
- **Backlog:** ~30 open (closed 11 this session: #462 epic + #461 + #463–#471; filed 2 follow-ups: cross-repo path-confinement hardening + config-loader locality refactor). Data-gated: #297 / #298.
