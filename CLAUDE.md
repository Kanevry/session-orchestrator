...
- **Tests:** 4449 passed / 11 skipped (stable 2026-05-10 deep-2; +17 net from new ci-status-banner.test.mjs (15) + listing.test.mjs DI restructure + session-schema.test.mjs spy-canary; one previously-skipped test resolved). validate-plugin 27/27, typecheck 67/67, lint 0, doc-consistency 6/6 passing. CI fully green on commit `<W5-deep-2>` (pipeline 3825) — 8-pipeline red streak (3798–3822) restored. Security gates: gitleaks 0 leaks, npm audit 0 vulnerabilities.
