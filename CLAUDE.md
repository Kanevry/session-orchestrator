...
- **Backlog:** 14 open issues (verified 2026-04-30 PM deep session; down from 17 after closing #161 D-axis-complete, #124 superseded by v3.2.0, #218 + #317 finished — all 11 nested .sh ports landed). #318 spawned as G-axis tracker (Owner Persona baseline propagation). Remaining cluster: epics (#229, #271, #229), baseline-MR-blocked (#314, #315, #318), autopilot-RUNS-blocked (#297, #298), tracking-only (#213, #123, #305), plus a thin tail of priority:low chores.
