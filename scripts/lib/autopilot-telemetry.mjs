/**
 * autopilot-telemetry.mjs — Telemetry helpers extracted from autopilot.mjs.
 *
 * Split introduced by issue #326 (refactor: decompose autopilot.mjs ~575 LoC).
 * autopilot.mjs imports from this module; this module does NOT import autopilot.mjs.
 */
