...
// ---------------------------------------------------------------------------
// validate() sub-validators (module-private)
// ---------------------------------------------------------------------------
//
// Each helper accepts the raw input + a mutable `errors` array + the section
// output to populate on success. Helpers preserve the original message
// strings and append-order so the public { ok, value, errors } return shape
// is byte-identical to the monolithic implementation.
