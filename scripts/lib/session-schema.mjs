/**
 * session-schema.mjs — producer-side schema lock for session JSONL entries.
 *
 * Issue #249 follow-up (producer-side schema lock).
 *
 * Companion to `scripts/lib/learnings.mjs` (Meta-Audit #265 M7). Provides a
 * plain-JS validator + normalizer for session records written to
 * `.orchestrator/metrics/sessions.jsonl`. No Zod — matches repo convention.
 *
 * Contract summary:
 ...
 * of scope here and belong in the backfill script.
 */
