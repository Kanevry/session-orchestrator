 ...
 *
 * ── CANONICAL SCHEMA (schema_version: 2) ─────────────────────────────────
 *
 ...
 *
 *   NEW SHAPE (v3+, schema_version: 1 or 2) — THIS IS THE CANONICAL SHAPE.
 *   The 1 -> 2 bump (#372) is additive-only — the shape below is unchanged:
 ...
 *
 * Required fields for a valid schema_version=2 record (unchanged since v1):
 ...
 *     CURRENT_SESSION_SCHEMA_VERSION (2) if absent. Unknown fields pass
 ...
 *     legacy, distinct from CURRENT_SESSION_SCHEMA_VERSION=2 stamped on
