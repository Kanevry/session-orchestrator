...
| #1278 | The complete validator exceeded its 30-second child budget during CI coverage. The two aggregate smoke callers now have a 60-second child budget and 65-second enclosing test/hook budget. | CI measured the companion scan at 25.95s; local profiling completed all 40 child checks in 8.157s with 229 pass / 0 fail. All assertions remain enabled. |
