...
- #1164 targets `rules/` (vendored deliverable library), not `.claude/rules/`; `.claude/rules/README.md` does not exist; 0/61 carry the vendored provenance header (correct). <!-- path-check: historical -->
## Recommendations
